		...
		self.utils.getPlayer(command).then(function(player) {
			...
			self.disnode.bot.SendEmbed(command.msg.channel_id, {
				...
				fields: [{
					...
					name: "Our Server",
					inline: false,
					value: "**Join our server for help with the whole bot: \n https://discord.gg/6G4Paj6"
				}, {
					name: 'Disnode Server',
					inline: false,
					value: "**Join the offical Server for Casino and get more support!:** https://discord.gg/AbZhCen",
				}, {
					name: 'Disnode Ultra',
					inline: false,
					value: "**This plugin was made by VictoryForPhil#4759, and FireGamer3#2163 help them keep the offical casino bot running 24/7 and get great perks on the offical casino by Purchasing Ultra:** https://disnodeteam.com/ultra if you buy ultra run `!casino ultra` to update your status in the bot",
				}],
				footer: {}
			});
		});
